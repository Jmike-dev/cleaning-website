...
export default function Home() {
  return (
    <>
    <div  className='bg-primary-dark-grey  rounded-b-lg  md:w-full sm:w-auto py-2 '>
       <div className='w-full relative '>
          ...
          <div className='relative left-1 md:absolute md:left-5 md:top-5 md:w-1/3 bottom-2'>
            <h1 className='text-xl text-primary-light-green hover:text-primary-green md:text-5xl '>Are you tired of cleaning then it's time to call us</h1>
          </div>
          <div className='relative py-1'>
              <a href="/" class=" absolute  bottom-1 left-64  rounded-full px-4 py-2 text-white bg-primary-green transition
